...
import { Sparkles, Mail, Lock, User, ArrowRight, ShieldCheck, Star, Eye, EyeOff, Loader2 } from 'lucide-react';
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="dark:text-white text-slate-900 font-medium">First Session Free</p>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-12 relative">
        ...
        <Card className="w-full max-w-md bg-muted/50 border-border shadow-2xl backdrop-blur-xl mt-8 md:mt-0">
          ...
          <CardContent className="space-y-6">
            ...
            {success && (
              <div className="rounded-lg bg-emerald-500/10 border border-emerald-500/30 px-4 py-4 text-sm text-emerald-400 flex flex-col gap-1">
                <p className="font-semibold text-base">✓ Account created successfully!</p>
                <p className="text-emerald-500/80">Please check your email to verify your account. Redirecting to login...</p>
              </div>
            )}
