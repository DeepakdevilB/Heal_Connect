...
import { Sparkles, Phone, ArrowRight, ShieldCheck, Star } from "lucide-react";
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-12 relative">
        ...
        <Card className="w-full max-w-md bg-muted/50 border-border shadow-2xl backdrop-blur-xl">
          <CardHeader className="space-y-2 pb-6">
            <CardTitle className="text-2xl font-bold dark:text-white text-slate-900 tracking-tight">Log in to your account</CardTitle>
            <CardDescription className="text-muted-foreground text-base">
              Enter your phone number to log in securely.
            </CardDescription>
          </CardHeader>
