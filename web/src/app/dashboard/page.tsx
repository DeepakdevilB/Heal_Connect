    ...
    <div className="min-h-screen bg-[#fffbf0] text-[#1a1a1a] flex flex-col font-sans">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: 'Wallet Balance', value: walletBalance !== null ? `₹${walletBalance.toFixed(2)}` : '...', icon: Wallet, color: 'text-[#f59e0b]', bg: 'bg-yellow-50' },
            ...
            { label: 'Experts Online', value: onlineCount > 0 ? String(onlineCount) : '—', icon: TrendingUp, color: 'text-blue-500', bg: 'bg-blue-50' },
          ].map((stat) => (
                      ...
                      <CardContent className="p-5">
                        ...
                        <div className="flex items-center justify-between mt-4 pt-4 border-t border-yellow-100">
                          ...
                          <div className="flex gap-2">
                            <Button size="sm" variant="outline" className="h-8 px-3 border-yellow-200 hover:border-yellow-400 hover:text-[#d97706]" onClick={(e) => { e.preventDefault(); startChatSession(expert.id, e); }} disabled={startingSession === expert.id}>
